...
async function handleProfileChange(profileName) {
    ...
    vr.setMainMeshVisibility(false);
    vr.addElement2Scene(ip.getInterpolatedData('S Concentration'), 'red');
    vr.addElement2Scene(ip.getInterpolatedData('Ca Concentration'), 'green');
    vr.addElement2Scene(ip.getInterpolatedData('Fe Concentration'), 'blue');
    //Update the face
